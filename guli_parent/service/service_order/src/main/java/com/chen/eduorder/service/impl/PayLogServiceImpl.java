...
import com.chen.eduorder.mapper.PayLogMapper;
import com.chen.eduorder.service.OrderService;
import com.chen.eduorder.service.PayLogService;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.chen.eduorder.utils.HttpClient;
...
public class PayLogServiceImpl extends ServiceImpl<PayLogMapper, PayLog> implements PayLogService {
    ...
    public Map createNative(String orderNo) {
        try {
            ...
            e.printStackTrace();
            throw new ChenException(20001, "获取二维码失败");
        }
    }
