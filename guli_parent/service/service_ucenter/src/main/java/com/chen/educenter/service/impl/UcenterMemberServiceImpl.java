...
public class UcenterMemberServiceImpl extends ServiceImpl<UcenterMemberMapper, UcenterMember> implements UcenterMemberService {
    ...
    public String login(UcenterMember ucenterMember) {
        ...
        if (StringUtils.isEmpty(mobile)||StringUtils.isEmpty(password)){
            throw new ChenException(20001,"手机号和密码为空");
        }
        //判断手机号是否正确
        ...
        if (mobileMember == null){
            throw new ChenException(20001,"手机号不存在");
        }
        ...
        if (!MD5.encrypt(password).equals(password1)){
            throw new ChenException(20001,"密码错误");
        }

        //判断用户是否被禁用
        if(mobileMember.getIsDisabled()){
            throw new ChenException(20001,"用户被禁用登录失败");
        }
    ...
    public void register(RegisterVo registerVo) {
        ...
        if (StringUtils.isEmpty(code)||StringUtils.isEmpty(mobile)||StringUtils.isEmpty(nickname)||StringUtils.isEmpty(password)){
            throw new ChenException(20001,"注册失败");
        }
        //判断验证码
        ...
        if (!code.equals(redisCode)){
            throw new ChenException(20001,"验证码错误,注册失败");
        }
        ...
        if (count > 0){
            throw new ChenException(20001,"手机号已存在,注册失败");
        }
        ...
        ucenterMember.setAvatar("https://chen01-edu.oss-cn-beijing.aliyuncs.com/2022/12/21/b96d65ffcebd4a99b31d114973a7eb38file.png");
